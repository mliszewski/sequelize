...
Model.prototype.bulkBuild = function(valueSets, options) { // testhint options:none
  ...
  //if we requested a promise then we want to break up the event loop here by injecting some setImmediates
  if(options.returnPromise) {
    return Promise.map(valueSets,function(values) {
      return new Promise(function(resolve) {
        return setImmediate(function() {
          var built = this.build(values, options);
