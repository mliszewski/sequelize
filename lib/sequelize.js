...
Sequelize.prototype.isDefined = function(modelName) {
  return !_.isUndefined(this.models[modelName])
};
...
Sequelize.prototype.query = function(sql, options) {
  ...
  if(this.options.dialect.supports.searchPath
      //do not prepend searchPath if command doesn't support it
    && options.supportsSearchPath !== false) {
    options.searchPath = this.options.hasOwnProperty('searchPath') ? this.options.searchPath : this.options.dialectOptions.defaultSearchPath
  }
