...
var QueryGenerator = {
  ...
  addSchema: function(param) {
    var self = this
      , schema = param.$schema ||
        (param.options && param.options.schema ? param.options.schema : undefined)
      , schemaDelimiter = param.$schemaDelimiter ||
        (param.options && param.options.schemaDelimiter ? param.options.schemaDelimiter : undefined);
