...
Instance.prototype.save = function(options) {
  ...
  return Promise.bind(this).then(function() {
    ...
    .then(function() {
      ...
      if (self.isNewRecord) {
        query = 'insert';
        args = [self, self.Model.getTableName(this.$options), values, options];
      } else {
        ...
        query = 'update';
        args = [self, self.Model.getTableName(this.$options), values, where, options];
      }
...
Instance.prototype.destroy = function(options) {
  ...
  return Promise.bind(this).then(function() {
    ...
    if (this.Model._timestampAttributes.deletedAt && options.force === false) {
      ...
      return this.sequelize.getQueryInterface().delete(this, this.Model.getTableName(this.$options), where, _.defaults(options, { type: QueryTypes.DELETE,limit: null}));
    }
  }).tap(function() {
    // Run after hook
    if (options.hooks) {
...
Instance.prototype.increment = function(fields, options) {
  ...
  return this.sequelize.getQueryInterface().increment(this, this.Model.getTableName(this.$options), values, where, options).return(this);
};
